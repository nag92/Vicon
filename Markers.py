    ...
    def make_markers(self):
        ...
        for key_name, value_name in self._data_dict.iteritems():
            ...
            for inx in xrange(len(x_filt)):
                point = Vicon.Point(x_arr[inx], y_arr[inx], z_arr[inx])
                self._raw_markers[fixed_name].append(point)
                point = Vicon.Point(x_filt[inx], y_filt[inx], z_filt[inx])
...
if __name__ == '__main__':
    DataSets1 = [Vicon.Point(531.6667, - 508.9951, 314.4273),
                 Vicon.Point(510.5082, - 457.7791, 357.1969),
                 Vicon.Point(463.9945, - 476.0904, 356.1137),
                 Vicon.Point(552.4579, - 566.4891, 393.5611),
                 Vicon.Point(505.9442, - 584.8004, 392.4779)]
    ...
    marker = [Vicon.Point(0.0, 50.0, 0.0),
              Vicon.Point(-70.0, 50.0, 0.0),
              Vicon.Point(-70, 0, 0),
              Vicon.Point(0.0, 50.0, 100.0),
              Vicon.Point(0.0, 0.0, 100.0)]
